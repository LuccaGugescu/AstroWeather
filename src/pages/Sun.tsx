                            ...
                            <IonRow>
                                {
                                    SOLAR_WIND_DATA.map(({ iconName, name }) => {
                                        return !isLoadingPlasma ? (
                                            <IonCol col-6 col-sm><DataCard iconName={iconName} name={name} value={plasmaData} key={name} /></IonCol>
                                        ) :
                                            (
                                ...
                                <IonCol col-6 col-sm><CustomDataCard x={solarWindData.x} y={solarWindData.y} /></IonCol>
                            </IonRow>
                        </IonGrid>
                    </IonContent>
                </IonPage>
